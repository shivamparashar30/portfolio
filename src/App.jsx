        ...
        <section>
          <div className="container m-auto px-4 py-10 flex gap-6">
            <div>
              ...
              <h1 className="font-bold text-2xl mt-3 gradiant-text">
            ...
            <div className="relative">
              <img
                className="relative border-cyan-600"
                style={{ borderRadius: "60%", borderBottomColor: "violet" }}
                src={Profile}
                width={300}
                height={250}
              />
            ...
            <div className="flex gap-16 mt-11 justify-center  ">
              <div className=" border rounded-md p-5 ">
                ...
                <p className="text-gray-400 text-sm mt-2">
                  Streamlines donations using React Native, MongoDB, Node.js
                  <br /> and Express.js.
                </p>
                <div className="flex  justify-center mt-2">
                  <button
                    ...
                    className=" px-5 py-2 border rounded-full bg-gradient-to-t from-blue-500 to-cyan-500 hover: from-blue-700 hover:to-cyan-700"
                  >
                    Checkout
                  </button>
                </div>
              ...
              <div className=" border rounded-md p-5">
                ...
                <p className="text-gray-400 text-sm mt-2">
                  Furniture E-commerce Store, built with React Native, MongoDB,
                  Node.js <br /> and Express.js.
                </p>
                <div className="flex  justify-center mt-2">
                  <button
                    onClick={() =>
          ...
          <section className="mt-12" id="technologies">
            <div className="container m-auto px-4 mt-12">
              ...
              <div className="mt-14">
                ...
                <span className="w-full h-2 mt-2 bg-gradient-to-t from-blue-500 to bg-cyan-500 block rounded-md"></span>
              </div>
              {/* tech-2 */}
              <div className="mt-8">
                <div className="flex justify-between items-center">
                ...
                <span className="w-[95%] h-2 mt-2 bg-gradient-to-t from-blue-500 to bg-cyan-500 block rounded-md"></span>
              </div>
              {/*tech-3 */}
              ...
              <div className="mt-8">
                ...
                <span className="w-[90%] h-2 mt-2 bg-gradient-to-t from-blue-500 to bg-cyan-500 block rounded-md"></span>
              </div>
              {/* tech-7 */}
              <div className="mt-8">
                <div className="flex justify-between items-center">
                ...
                <span className="w-[75%] h-2 mt-2 bg-gradient-to-t from-blue-500 to bg-cyan-500 block rounded-md"></span>
              </div>
              {/* tech-8 */}
              <div className="mt-8">
                <div className="flex justify-between items-center">
                ...
                <span className="w-[50%] h-2 mt-2 bg-gradient-to-t from-blue-500 to bg-cyan-500 block rounded-md"></span>
              </div>
            </div>
          </section>
            ...
            <div className="container m-auto px-4">
              ...
              <div className="mt-12 relative before:absolute before:top-0 before:left-16 before:rounded-full before:bottom-10 sm:before:bottom-2 before:w-1 before:bg-white">
                ...
                <div className="pl-24 relative before:w-4 before:h-4 before:bg-gradient-to-t before:from-blue-500 before:to-cyan-500 before:absolute before:rounded-full before:left-[58px]">
                  ...
                  <p>
                    Completed BCA - Bachelor of Computer Applications from Aryan
                    College Ajmer.
                  </p>
                </div>
                ...
                <div className="pl-24 mt-24 relative before:w-4 before:h-4 before:bg-gradient-to-t before:from-blue-500 before:to-cyan-500 before:absolute before:rounded-full before:left-[58px]">
                  ...
                  <p>
                    Completed MCA - Master of Computer Applications from PES
                ...
                <div className="pl-24 mt-24 relative before:w-4 before:h-4 before:bg-gradient-to-t before:from-blue-500 before:to-cyan-500 before:absolute before:rounded-full before:left-[58px]">
                  ...
                  <div>
                    <h4 className="font-semibold text-blue-400 mb-2">
                      Software Developer Intern - Tigbar (Remote)
                    </h4>
                    ...
                    <ul className="text-gray-300 text-sm space-y-1">
                      <li>
                        • Worked on cross-platform app development using React
                        Native
                      </li>
                      <li>
                        • Collaborated with teams using Agile methodologies and
                        Jira
                      </li>
                      <li>
                      ...
                      <li>
                        • Used GitHub for version control and seamless code
                        integration
                      </li>
                    </ul>
                  </div>
                ...
                <div className="pl-24 mt-24 relative before:w-4 before:h-4 before:bg-gradient-to-t before:from-blue-500 before:to-cyan-500 before:absolute before:rounded-full before:left-[58px]">
                  ...
                  <div>
                    <h4 className="font-semibold text-blue-400 mb-2">
                      Front-End Developer - Grofo (Remote)
                    </h4>
                    <p className="text-gray-400 text-sm mb-2">
                    ...
                    <ul className="text-gray-300 text-sm space-y-1">
                      <li>
                        • Developing comprehensive CRM solutions for chemical
                        companies using React.js
                      </li>
                      <li>
                        • Creating user-centered interfaces in Figma with focus
                        on client satisfaction
                      </li>
                      <li>
                        • Managing complete development lifecycle from
      ...
      <footer className="md-8">
        ...
        {scrolling && (
          <div className="md-6 flex justify-center">
            <button
              className="right-5 top-6  bottom-0 w-24"
              onClick={() => {
                window.scrollTo(0, 0);
              }}
            >
